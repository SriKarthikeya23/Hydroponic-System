...
function App() {
  ...
  const getMotorState = () => {
    Axios.get('http://65.49.44.136:3002/get/motor').then((res) => {
  ...
  const postMotorState = (state) => {
    Axios.post('http://65.49.44.136:3002/post/motor', {
      data: state
    }).then((response) => {
  ...
  const getData = () => {
    Axios.get('http://65.49.44.136:3002/get/hydroponic/data').then((response) => {
